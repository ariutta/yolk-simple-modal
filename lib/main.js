...
// and kaavio-editor.
// For the moment, we are dependent on the kludge of just using
// window.m instead of requiring it.
var m = require('mithril');
// NOTE: need to do this so that we can avoid the headaches of trying
// to work with uncompiled coffescript, jade and CSS (such as during
// unit testing in Node.js with jsdom).
//var createSimpleModal = require('simple-modal/bundle.js');
//var createSimpleModal = require('simple-modal/lib/bundle.js');
var createSimpleModal = require('../node_modules/simple-modal/simple-modal.compiled.js');
//var createSimpleModal = require('../node_modules/simple-modal/lib/bundle.js');
//var createSimpleModal = require('../simple-modal-bundle.js');

var Spinner = require('spin.js');

module.exports = (function(window) {
  console.log('window.createSimpleModal');
  console.log(window.createSimpleModal);
  console.log('createSimpleModal');
  console.log(createSimpleModal);
  console.log(createSimpleModal.toString());

  var args1 = {};
  args1.content = '';
  args1.attachToBody = false;
  args1.removeOnClose = false;

  var modalInstance1 = createSimpleModal(args1);
  console.log('modalInstance1 at 30');
  console.log(modalInstance1);
  var modalContainer1 = modalInstance1.m;
  ...
  */
  modalComponent.config = function(ctrl) {
    return function(element, isInitialized) {
      ...
      if (!isInitialized) {
        ...
        // Need to do this to give createSimpleModal placeholder content
        args.content = '';
        ...
        if (!modalContainer) {
          console.log('createSimpleModal at 75');
          console.log(createSimpleModal);
          var modalInstance = createSimpleModal(args);
  ...
  console.log('mSimpleModal in main.js');
